...
<div class="sidebar">
    ...
    <ul class="sidebar-nav">
        ...
        <!-- ADD THIS NEW LINE (Line 10) -->
        <li class="<?php if($current_page == 'kitchen_view.php') echo 'active'; ?>"><a href="kitchen_view.php"><i class="fas fa-concierge-bell"></i>Kitchen View</a></li>
